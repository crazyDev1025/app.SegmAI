...
const K = {
  ...
  et = t(
    "div",
    null,
    [p("Daily Earn "), t("span", { class: "text-lime-400" }, "~13 $SEGMAI")],
    -1
  ),
  ot = {
    key: 0,
...
const rt = z(K, [["render", lt]]),
  at = { class: "p-7 w-full" },
  nt = B(
    '<div class="text-4xl text-lime-50 font-bold mt-20"> Discover the <b class="text-lime-400">C</b>oralAI <b class="text-lime-400">Power</b></div><div class="text-4xl text-lime-50 mt-16"> Join the Computation<br> Revolution: <span class="text-lime-400"> Where Your<br> GPU&#39;s Power Meets Purpose</span></div>',
    2
  ),
  dt = { class: "mt-20" },
  ct = { class: "flex" },
  mt = t(
    "a",
    {
      href: "https://SEGMAI.gitbook.io/SEGMAI/marketplace-decentralizing-computing-power",
      target: "_blank",
      class:
